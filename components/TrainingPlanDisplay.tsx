    ...
    <div className="max-w-6xl mx-auto py-12 px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-emerald-500 rounded-[2rem] p-8 text-slate-950 relative overflow-hidden group">
            <i className="fas fa-quote-right absolute top-4 right-4 text-6xl opacity-10 group-hover:scale-110 transition-transform"></i>
            <h3 className="text-xs font-black uppercase tracking-widest mb-2 opacity-60">Pro Tip</h3>
            <p className="font-bold text-lg leading-tight italic">
              "Fokus auf die Qualität, nicht die Quantität. Woche {currentWeek.weekNumber} dient dazu, deine {currentWeek.focus.toLowerCase()} zu festigen."
            </p>
          </div>
        </div>
      </div>
